...
const STRINGS = {
  ...
  boardZoomLevel: { en: 'Zoom {zoom} · stops appear from {min}', th: 'ซูม {zoom} · ป้ายแสดงตั้งแต่ {min}' },
  boardPickHint: { en: 'Tap a stop to see where its buses go', th: 'แตะป้ายเพื่อดูว่ารถเมล์ไปไหน' },
  boardZoomAll: { en: 'Zoom to all', th: 'ซูมดูทุกสาย' },
  boardZoomRoute: { en: 'Zoom to {n}', th: 'ซูมดูสาย {n}' },
  boardZoomStop: { en: 'Zoom to stop', th: 'ซูมดูป้าย' },
  boardLabelsHide: { en: 'Hide labels', th: 'ซ่อนป้ายกำกับ' },
  boardLabelsShow: { en: 'Show labels', th: 'แสดงป้ายกำกับ' },
  ...
  testViewport: { en: 'Viewport', th: 'ขนาดหน้าจอ' },
  viewportDesktop: { en: 'Desktop', th: 'เดสก์ท็อป' },
  viewportPhone: { en: 'Phone', th: 'โทรศัพท์' },
  viewportPhoneFull: { en: 'Phone, full screen', th: 'โทรศัพท์ เต็มจอ' },
