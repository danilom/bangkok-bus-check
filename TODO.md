...
- [x] Map popup: with a fix, "1.2 km away · 3 stops back / 12 stops from
      here" (the count only within 300 m of a stop); without one, the old
      "stop 16 of 64". Other routes at the stop would be the reverse lookup.
